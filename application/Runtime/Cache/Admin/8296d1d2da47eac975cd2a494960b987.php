    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/309/admin.php/AddContent/paper" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">论文</a>
        ...
        <div class="col-md-9 col-sm-7">
            ...
            <form action="/309/admin.php/AddContent/addpaper" method="post" enctype="multipart/form-data">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="请输入外部链接" style="font-family: '微软雅黑', '黑体'" name="link">
                </div>
                <div class="form-group">
