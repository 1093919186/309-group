...
<div class="container" id="content">
    <div class="row">
        ...
        <div class="col-md-9 col-sm-7">
            ...
            <form action="/309/admin.php/AdmPeople/upstuend/sid/<?php echo ($students["id"]); ?>" method="post"  enctype="multipart/form-data">
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">姓名</label>
                    <input class="form-control" value="<?php echo ($students["name"]); ?>" style="font-family: '微软雅黑', '黑体'" name="name">
                </div>
                <div class="form-group">
                ...
                <div id="main" role="main">
                    ...
                    <div id="simple-editor" style="font-family: '微软雅黑', '黑体'">
                        <?php echo ($students["content"]); ?>
                    </div>
                </div>
                <select class="form-control" style="font-family: '微软雅黑', '黑体'" name="type">
                    <?php if($students["type"] == 4): ?><option selected="selected">毕业博士</option>
                        <option>在读博士</option>
                        <option>毕业硕士</option>
                        <option>在读硕士</option>
                        <?php elseif($students["type"] == 5): ?>
                        <option>毕业博士</option>
                        <option selected="selected">在读博士</option>
                        <option>毕业硕士</option>
                        <option>在读硕士</option>
                        <?php elseif($students["type"] == 6): ?>
                        <option>毕业博士</option>
                        <option>在读博士</option>
                        <option selected="selected">毕业硕士</option>
                        <option>在读硕士</option>
                        <?php else: ?>
                        <option>毕业博士</option>
                        <option>在读博士</option>
                        <option>毕业硕士</option>
                        <option selected="selected">在读硕士</option><?php endif; ?>
                </select>
                <br>
