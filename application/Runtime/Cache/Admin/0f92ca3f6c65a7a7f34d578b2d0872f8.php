...
<div class="container" id="content">
    <div class="row">
        ...
        <div class="col-md-9 col-sm-7">
            ...
            <form action="/309/admin.php/AdmAffairs/upnewsend/nid/<?php echo ($news["id"]); ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">标题</label>
                    <input class="form-control" value="<?php echo ($news["title"]); ?>" style="font-family: '微软雅黑', '黑体'" name="title">
                </div>
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">摘要</label>
                    <textarea class="form-control" rows="3" style="font-family: '微软雅黑', '黑体'" name="header"><?php echo ($news["header"]); ?></textarea>
                </div>
                <div class="form-group">
