    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                <a href="/309/admin.php/AdmAffairs/index" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">公告管理</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">公告管理</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                        ...
                        <td style="font-family: '微软雅黑', '黑体'"><a href="/309/admin.php/AdmAffairs/upinfo/iid/<?php echo ($v["infoid"]); ?>"><?php echo ($v["title"]); ?></a></td>
                        <td><?php echo ($v["hints"]); ?></td>
                        <td><a href="/309/admin.php/AdmAffairs/upinfo/iid/<?php echo ($v["infoid"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                            <a href="/309/admin.php/AdmAffairs/delinfo/iid/<?php echo ($v["infoid"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
