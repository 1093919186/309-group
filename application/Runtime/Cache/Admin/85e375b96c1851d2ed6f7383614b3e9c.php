            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($message)): foreach($message as $key=>$v): ?><tr>
                        ...
                        <td style="font-family: '微软雅黑', '黑体'"><a href="/309/admin.php/AdmAffairs/operate/mid/<?php echo ($v["id"]); ?>"><?php echo ($v["contact"]); ?></a></td>
                        <?php if($v["type"] == 0): ?><td><span style="font-family: 'arial', '微软雅黑'">未处理</span></td>
                            <?php else: ?>
                            <td><span style="font-family: 'arial', '微软雅黑'">已处理</span></td><?php endif; ?>
                        <td><a href="/309/admin.php/AdmAffairs/del/mid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
