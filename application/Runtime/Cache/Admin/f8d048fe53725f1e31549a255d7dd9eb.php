    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/309/admin.php/AddContent/info" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">发布公告</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">发布公告</li>
            </ul>
            <form action="/309/admin.php/AddContent/addinfo" method="post">
                <div class="form-group">
