...
<div class="container" id="content">
    <div class="row">
        ...
        <div class="col-md-9 col-sm-7">
            ...
            <form action="/309/admin.php/AdmWritings/uppatentend/pid/<?php echo ($patent["id"]); ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">标题</label>
                    <input class="form-control" value="<?php echo ($patent["name"]); ?>" style="font-family: '微软雅黑', '黑体'" name="title">
                </div>
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">类型</label>
                    <input class="form-control" value="<?php echo ($patent["origin"]); ?>" style="font-family: '微软雅黑', '黑体'" name="type">
                </div>
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">公告时间</label>
                    <input class="form-control" value="<?php echo ($patent["data"]); ?>" style="font-family: '微软雅黑', '黑体'" name="time">
                </div>
                <div id="main" role="main">
                    <label style="font-family: 'arial', '微软雅黑'">内容</label>
                    <div id="simple-editor" style="font-family: '微软雅黑', '黑体'">
                        <?php echo ($patent["content"]); ?>
                    </div>
                </div>
