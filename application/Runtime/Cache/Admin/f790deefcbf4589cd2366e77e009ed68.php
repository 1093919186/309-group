...
<div class="container" id="content">
    <div class="row">
        ...
        <div class="col-md-9 col-sm-7">
            ...
            <form action="/309/admin.php/AdmWritings/upboend/bid/<?php echo ($books["id"]); ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">标题</label>
                    <input class="form-control" value="<?php echo ($books["name"]); ?>" style="font-family: '微软雅黑', '黑体'" name="name">
                </div>
                <div class="form-group">
