    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/309/admin.php/AdmAffairs/news" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">新闻管理</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">新闻管理</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($news)): foreach($news as $key=>$v): ?><tr>
                            ...
                            <td style="font-family: '微软雅黑', '黑体'"><a href="/309/admin.php/AdmAffairs/upnews/nid/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a></td>
                            <td><a href="/309/admin.php/AdmAffairs/upnews/nid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                                <a href="/309/admin.php/AdmAffairs/delnews/nid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
