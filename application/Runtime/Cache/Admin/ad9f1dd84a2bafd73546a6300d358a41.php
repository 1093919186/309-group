    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                <a href="/309/admin.php/AdmPeople/index" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">老师</a>
                <a href="/309/admin.php/AdmPeople/students" class="list-group-item" style="font-family: '微软雅黑', '黑体'">学生</a>
            </div>
        </div>
        <!--end-->
        <!--右侧-->
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">老师</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($people)): foreach($people as $key=>$v): ?><tr>
                        <td style="font-family: '微软雅黑', '黑体'"><a href="/309/admin.php/AdmPeople/upteachers/tid/<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a></td>
                        <?php if($v["type"] == 1): ?><td style="font-family: '微软雅黑', '黑体'">教授</td>
                        <?php elseif($v["type"] == 2): ?>
                            <td style="font-family: '微软雅黑', '黑体'">副教授</td>
                        <?php else: ?>
                            <td style="font-family: '微软雅黑', '黑体'">讲师</td><?php endif; ?>
                        <td><a href="/309/admin.php/AdmPeople/upteachers/tid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                            <a href="/309/admin.php/AdmPeople/delteachers/tid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
