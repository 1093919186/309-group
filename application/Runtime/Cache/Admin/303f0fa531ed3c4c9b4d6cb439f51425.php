    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/309/admin.php/AddContent/sciRew" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">科研奖励</a>
        ...
        <div class="col-md-9 col-sm-7">
            ...
            <form action="/309/admin.php/AddContent/scirews" method="post">
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">成果名称</label>
                    <input class="form-control" placeholder="请输入名称" style="font-family: '微软雅黑', '黑体'" name="name">
                </div>
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">奖励级别</label>
                    <input class="form-control" placeholder="请输入奖励级别" style="font-family: '微软雅黑', '黑体'" name="level">
                </div>
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">年度</label>
                    <input class="form-control" placeholder="请输入年度" style="font-family: '微软雅黑', '黑体'" name="year">
                </div>
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">完成人</label>
                    <input class="form-control" placeholder="请输入完成人" style="font-family: '微软雅黑', '黑体'" name="endman">
                </div>
