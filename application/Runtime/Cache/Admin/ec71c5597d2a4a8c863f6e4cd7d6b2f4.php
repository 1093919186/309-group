    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                <a href="/309/admin.php/AdmAca/index" class="list-group-item" style="font-family: '微软雅黑', '黑体'">国际学术交流</a>
                <a href="/309/admin.php/AdmAca/nationAca" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">国内学术交流</a>
            </div>
        </div>
        <!--end-->
        <!--右侧-->
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">国内学术交流</li>
            </ul>
            <form action="/309/admin.php/AdmAca/upacanaend/aid/<?php echo ($nation["id"]); ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">标题</label>
                    <input class="form-control" value="<?php echo ($nation["title"]); ?>" style="font-family: '微软雅黑', '黑体'" name="title">
                </div>
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">摘要</label>
                    <textarea class="form-control" rows="3" style="font-family: '微软雅黑', '黑体'" name="header"><?php echo ($nation["header"]); ?></textarea>
                </div>
                <div class="form-group">
                ...
                <div id="main" role="main">
                    ...
                    <div id="simple-editor" style="font-family: '微软雅黑', '黑体'">
                        <?php echo ($nation["content"]); ?>
                    </div>
                </div>
                <select class="form-control" style="font-family: '微软雅黑', '黑体'" name="type">
                    <?php if($nation["type"] == 0): ?><option selected="selected">国际学术交流</option>
