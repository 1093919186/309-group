    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                <a href="/309/admin.php/AddContent/index" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">科研项目</a>
                ...
                <a href="/309/admin.php/AddContent/patent" class="list-group-item" style="font-family: '微软雅黑', '黑体'">授权、申请专利</a>
            </div>
        </div>
        <!--end-->
        <!--右侧-->
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">科研成果</li>
            </ul>
            <form action="/309/admin.php/AddContent/scipro" method="post">
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">标题</label>
                    <input class="form-control" placeholder="请输入标题" style="font-family: '微软雅黑', '黑体'" name="name">
                </div>
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">课题来源</label>
                    <input class="form-control" placeholder="请输入课题来源" style="font-family: '微软雅黑', '黑体'" name="origin">
                </div>
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">起止时间</label>
                    <input class="form-control" placeholder="请输入起止时间" style="font-family: '微软雅黑', '黑体'" name="data">
                </div>
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">负责人</label>
                    <input class="form-control" placeholder="请输入负责人" style="font-family: '微软雅黑', '黑体'" name="duty">
                </div>
