    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                <a href="/309/admin.php/AdmPeople/index" class="list-group-item" style="font-family: '微软雅黑', '黑体'">老师</a>
                <a href="/309/admin.php/AdmPeople/students" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">学生</a>
            </div>
        </div>
        <!--end-->
        <!--右侧-->
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                <li>309CMS</li>
                <li style="font-family: '微软雅黑', '黑体'">人物管理</li>
                <li class="active" style="font-family: '微软雅黑', '黑体'">学生</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($students)): foreach($students as $key=>$v): ?><tr>
                        <td style="font-family: '微软雅黑', '黑体'"><a href="/309/admin.php/AdmPeople/upstudents/sid/<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a></td>
                        <?php if($v["type"] == 4): ?><td style="font-family: '微软雅黑', '黑体'">毕业博士</td>
                            <?php elseif($v["type"] == 5): ?>
                            <td style="font-family: '微软雅黑', '黑体'">在读博士</td>
                            <?php elseif($v["type"] == 6): ?>
                            <td style="font-family: '微软雅黑', '黑体'">毕业硕士</td>
                            <?php else: ?>
                            <td style="font-family: '微软雅黑', '黑体'">在读硕士</td><?php endif; ?>
                        <td><a href="/309/admin.php/AdmPeople/upstudents/sid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                            <a href="/309/admin.php/AdmPeople/delstudents/sid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
