        ...
        <div class="col-md-9 col-sm-7">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($nation)): foreach($nation as $key=>$v): ?><tr>
                            <td><?php echo (mbtime($v["dateandtime"])); ?></td>
                            <td style="font-family: '微软雅黑', '黑体'"><a href="/309/admin.php/AdmAca/upacana/aid/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a></td>
                            <td><a href="/309/admin.php/AdmAca/upacana/aid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                                <a href="/309/admin.php/AdmAca/delacana/aid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
