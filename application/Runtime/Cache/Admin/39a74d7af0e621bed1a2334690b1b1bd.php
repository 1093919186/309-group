    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/309/admin.php/AdmWritings/paper" class="list-group-item" style="font-family: '微软雅黑', '黑体'">论文</a>
                <a href="/309/admin.php/AdmWritings/patent" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">授权、申请专利</a>
            </div>
        </div>
        <!--end-->
        <!--右侧-->
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">授权、申请专利</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($patent)): foreach($patent as $key=>$v): ?><tr>
                        <td style="font-family: '微软雅黑', '黑体'"><a href="/309/admin.php/AdmWritings/uppatent/pid/<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a></td>
                        <td style="font-family: '微软雅黑', '黑体'"><?php echo ($v["origin"]); ?></td>
                        <td><a href="/309/admin.php/AdmWritings/uppatent/pid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                            <a href="/309/admin.php/AdmWritings/delpatent/pid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
