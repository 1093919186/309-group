    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/309/admin.php/AddContent/writings" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">出版著作</a>
        ...
        <div class="col-md-9 col-sm-7">
            ...
            <form action="/309/admin.php/AddContent/addbooks" method="post" enctype="multipart/form-data">
                <div class="form-group">
