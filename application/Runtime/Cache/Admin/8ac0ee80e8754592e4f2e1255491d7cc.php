    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/309/admin.php/AddContent/news" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">发布新闻</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">发布新闻</li>
            </ul>
            <form action="/309/admin.php/AddContent/addnews" method="post" enctype="multipart/form-data">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" placeholder="请输入文章第一段" rows="3" style="font-family: '微软雅黑', '黑体'" name="header"></textarea>
                </div>
                <div class="form-group">
