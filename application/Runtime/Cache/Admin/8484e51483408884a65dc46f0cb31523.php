    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/309/admin.php/AddContent/people" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">增加人物</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">增加人物</li>
            </ul>
            <form action="/309/admin.php/AddContent/addpeople" method="post" enctype="multipart/form-data">
                <div class="form-group">
