        ...
        <div class="col-md-9 col-sm-7">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($papers)): foreach($papers as $key=>$v): ?><tr>
                        <td style="font-family: '微软雅黑', '黑体'"><a href="/309/admin.php/AdmWritings/uppapers/pid/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a></td>
                        <td style="font-family: '微软雅黑', '黑体'"><?php echo ($v["writer"]); ?></td>
                        <td><a href="/309/admin.php/AdmWritings/uppapers/pid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                            <a href="/309/admin.php/AdmWritings/delpapers/pid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
