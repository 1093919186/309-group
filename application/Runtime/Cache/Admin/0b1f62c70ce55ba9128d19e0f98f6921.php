    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                <a href="/309/admin.php/AdmImg/index" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">网站图片</a>
                <a href="/309/admin.php/AdmImg/upPic" class="list-group-item" style="font-family: '微软雅黑', '黑体'">上传图片</a>
                <a href="/309/admin.php/AdmImg/outPic" class="list-group-item" style="font-family: '微软雅黑', '黑体'">外部图片</a>
            </div>
        </div>
        <!--end-->
        <!--右侧-->
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">图片管理</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($img)): foreach($img as $key=>$v): ?><tr>
                        <td style="font-family: '微软雅黑', '黑体'"><img src="/309/<?php echo ($v["imgpath"]); ?>" style="width: 40%"></td>
                        <td><form action="/309/admin.php/AdmImg/upimg/mid/<?php echo ($v["id"]); ?>" method="post"  enctype="multipart/form-data">
                            <div class="form-group">
                                <input type="file" id="exampleInputFile" name="imgpath">
                                <br>
                                <input class="form-control" placeholder="请输入链接" style="font-family: '微软雅黑', '黑体'" value="<?php echo ($v["links"]); ?>" name="links">
                            </div>
