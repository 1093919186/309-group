    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/309/admin.php/AdmImg/upPic" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">上传图片</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">上传图片</li>
            </ul>
            <div class="table-responsive">
                <form action="/309/admin.php/AdmImg/upPicend" method="post"  enctype="multipart/form-data">
                    <div class="form-group">
