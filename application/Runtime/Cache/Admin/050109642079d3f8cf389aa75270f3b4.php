...
<div class="container" id="content">
    <div class="row">
        ...
        <div class="col-md-9 col-sm-7">
            ...
            <form action="/309/admin.php/AdmPeople/upteaend/tid/<?php echo ($teachers["id"]); ?>" method="post"  enctype="multipart/form-data">
                <div class="form-group">
                    <label style="font-family: 'arial', '微软雅黑'">姓名</label>
                    <input class="form-control" value="<?php echo ($teachers["name"]); ?>" style="font-family: '微软雅黑', '黑体'" name="name">
                </div>
                <div class="form-group">
                ...
                <select class="form-control" style="font-family: '微软雅黑', '黑体'" name="type">
                    <?php if($teachers["type"] == 1): ?><option selected="selected">教授</option>
                        <option>副教授</option>
                        <option>讲师</option>
                        <?php elseif($teachers["type"] == 2): ?>
                        <option>教授</option>
                        <option selected="selected">副教授</option>
                        <option>讲师</option>
                        <?php else: ?>
                        <option>教授</option>
                        <option>副教授</option>
                        <option selected="selected">讲师</option><?php endif; ?>
                </select>
                <br>
