    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                <a href="/309/admin.php/AdmWritings/index" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">出版著作</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">出版著作</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($books)): foreach($books as $key=>$v): ?><tr>
                        <td style="font-family: '微软雅黑', '黑体'"><a href="/309/admin.php/AdmWritings/upbooks/bid/<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a></td>
                        <td><a href="/309/admin.php/AdmWritings/upbooks/bid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                            <a href="/309/admin.php/AdmWritings/delbooks/bid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
