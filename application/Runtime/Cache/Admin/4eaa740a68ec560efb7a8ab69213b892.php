    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                <a href="/309/admin.php/AdmImg/index" class="list-group-item" style="font-family: '微软雅黑', '黑体'">网站图片</a>
                <a href="/309/admin.php/AdmImg/upPic" class="list-group-item" style="font-family: '微软雅黑', '黑体'">上传图片</a>
                <a href="/309/admin.php/AdmImg/outPic" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">外部图片</a>
            </div>
        </div>
        <!--end-->
        <!--右侧-->
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">外部图片</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($img)): foreach($img as $key=>$v): ?><tr>
                            <td style="font-family: '微软雅黑', '黑体'"><img src="/309/<?php echo ($v["imgpath"]); ?>" style="width: 100px;height: 50px"></td>
                            <td><a href="/309/admin.php/AdmImg/deloutpic/oid/<?php echo ($v["id"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td></td>
