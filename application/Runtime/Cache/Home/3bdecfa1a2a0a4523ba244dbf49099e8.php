        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <div class="col-md-3" id="left-list">
                <div class="list-group" style="text-align: center">
                    <a href="/309/index.php/SciFruits/index" class="list-group-item" >科研项目</a>
                    <a href="/309/index.php/SciFruits/scirew" class="list-group-item active" >科研奖励</a>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" style="background-color: #fff;">
                        ...
                        <?php if(is_array($scirews)): foreach($scirews as $key=>$v): ?><tr>
                            ...
                            <td style="font-size: 13px"><?php echo ($v["level"]); ?></td>
                            <td style="font-size: 13px"><?php echo ($v["year"]); ?></td>
                            <td style="font-size: 13px"><?php echo ($v["endman"]); ?></td>
