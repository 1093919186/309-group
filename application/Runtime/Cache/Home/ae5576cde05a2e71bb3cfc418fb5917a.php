            ...
            <main class="col-md-12" style="background-color: #fff;margin: 10px 0;">
                <article id=111 class="post">
                    <div class="post-head">
                        ...
                        <div class="post-meta">
                            <span class="author">浏览：<?php echo ($news["hints"]); ?></span> &bull;
                            <time class="post-date"><?php echo (mbtime($news["dateandtime"])); ?></time>
                        </div>
                    </div>
                    ...
                    <div class="featured-media" style="text-align: center">                    <!--此处注意-->
                        <img src="/309/<?php echo ($news["imgpath"]); ?>" alt="" style="width: 70%">
                    </div>
                    <div class="post-content">
