    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/309/index.php/News/index">新闻动态</a></li>
            ...
            <div class="col-md-3" id="left-list">
                <div class="list-group" style="text-align: center">
                    <a href="/309/index.php/Academic/index" class="list-group-item" >国际学术交流</a>
                    <a href="/309/index.php/Academic/nation" class="list-group-item active" >国内学术交流</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" style="background-color: #fff;">
                        ...
                        <?php if(is_array($nationaca)): foreach($nationaca as $key=>$v): ?><tr>
                            <td><a href="/309/index.php/Academic/details/cid/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a></td>
