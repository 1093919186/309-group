        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <div class="col-md-3" id="left-list">
                <div class="list-group" style="text-align: center">
                    <a href="/309/index.php/Teachers/index" class="list-group-item active" >教授</a>
                    <a href="/309/index.php/Teachers/viceprofessor" class="list-group-item" >副教授</a>
            ...
            <div class="col-md-9">
                ...
                <?php if(is_array($professor)): foreach($professor as $key=>$v): ?><div class="col-md-4" style="text-align: center">
