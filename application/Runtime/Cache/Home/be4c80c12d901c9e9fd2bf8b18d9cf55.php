        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <div class="col-md-3" id="left-list">
                <div class="list-group" style="text-align: center">
                    <a href="/309/index.php/Teachers/index" class="list-group-item" >教授</a>
                    <a href="/309/index.php/Teachers/viceprofessor" class="list-group-item active" >副教授</a>
                    <a href="/309/index.php/Teachers/teachers" class="list-group-item" >讲师</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <?php if(is_array($viceprofessor)): foreach($viceprofessor as $key=>$v): ?><div class="col-md-4" style="text-align: center">
