        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <div class="col-md-3" id="left-list">
                <div class="list-group" style="text-align: center">
                    ...
                    <a href="/309/index.php/Teachers/teachers" class="list-group-item active" >讲师</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <?php if(is_array($teachers)): foreach($teachers as $key=>$v): ?><div class="col-md-4" style="text-align: center">
