        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <div class="col-md-3" id="left-list">
                <div class="list-group" style="text-align: center">
                    ...
                    <a href="/309/index.php/Students/master" class="list-group-item active" >毕业硕士</a>
            ...
            <div class="col-md-9">
                ...
                <?php if(is_array($master)): foreach($master as $key=>$v): ?><div class="col-md-4" style="text-align: center">
