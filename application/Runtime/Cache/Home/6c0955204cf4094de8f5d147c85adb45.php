            ...
            <main class="col-md-12" style="background-color: #fff;margin: 10px 0;">
                <article id=111 class="post">
                    <div class="post-head">
                        ...
                        <div class="post-meta">
                            <span class="author">浏览：<?php echo ($paper["hints"]); ?></span> &bull;
                            <span class="author">作者：<?php echo ($paper["writer"]); ?></span> &bull;
                            <time class="post-date"><?php echo (mbtime($paper["dateandtime"])); ?></time>
                        </div>
                    </div>
                    <div class="post-content">
                        <?php echo ($paper["content"]); ?>
                        <br><br>
                        <a href="<?php echo ($paper["link"]); ?>"><?php echo ($paper["link"]); ?></a>
                        <p style="margin-top: 10px">附件【<a href="/309/<?php echo ($paper["loads"]); ?>"><?php echo ($paper["title"]); ?></a>】</p>
                    </div>
                </article>
