        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <div class="col-md-3" id="left-list">
                <div class="list-group" style="text-align: center">
                    ...
                    <a href="/309/index.php/Writings/englishpaper" class="list-group-item" >英文论文</a>
                    <a href="/309/index.php/Writings/patent" class="list-group-item active" >授权、申请专利</a>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" style="background-color: #fff;">
                        ...
                        <?php if(is_array($patent)): foreach($patent as $key=>$v): ?><tr>
                            <td><a href="/309/index.php/Writings/patdetails/pid/<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a></td>
