        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <div class="col-md-3" id="left-list">
                <div class="list-group" style="text-align: center">
                    <a href="/309/index.php/Academic/index" class="list-group-item active" >国际学术交流</a>
                    <a href="/309/index.php/Academic/nation" class="list-group-item" >国内学术交流</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" style="background-color: #fff;">
                        ...
                        <?php if(is_array($interaca)): foreach($interaca as $key=>$v): ?><tr>
                            <td><a style="font-size: 13px" href="/309/index.php/Academic/details/cid/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a></td>
                            <td style="font-size: 13px"><?php echo (mbtime($v["dateandtime"])); ?></td>
