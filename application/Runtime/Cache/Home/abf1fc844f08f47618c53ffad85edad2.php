...
<title><?php echo ($academic["title"]); ?></title>
<head>
    <meta charset="utf-8">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <main class="col-md-12" style="background-color: #fff;margin: 10px 0;">
                <article id=111 class="post">
                    <div class="post-head">
                        <h2><?php echo ($academic["title"]); ?></h2>
                        <div class="post-meta">
                            <span class="author">浏览：<?php echo ($academic["hints"]); ?></span> &bull;
                            <time class="post-date"><?php echo (mbtime($academic["dateandtime"])); ?></time>
                        </div>
                    </div>
                    <div class="post-content">
                        <?php echo ($academic["header"]); ?>
                    </div>
                    <div class="featured-media" style="text-align: center">                    <!--此处注意-->
                        <img src="/309/<?php echo ($academic["imgpath"]); ?>" alt="" style="width: 70%">
                    </div>
                    <div class="post-content">
                        <?php echo ($academic["content"]); ?>
                    </div>
                </article>
