        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <div class="col-md-3" id="left-list">
                <div class="list-group" style="text-align: center">
                    ...
                    <a href="/309/index.php/Students/readdoctor" class="list-group-item" >在读博士</a>
                    <a href="/309/index.php/Students/master" class="list-group-item" >毕业硕士</a>
                    <a href="/309/index.php/Students/readmaster" class="list-group-item active" >在读硕士</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <?php if(is_array($readmaster)): foreach($readmaster as $key=>$v): ?><div class="col-md-4" style="text-align: center">
